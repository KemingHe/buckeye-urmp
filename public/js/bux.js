...

{
  function setFigcaptionMargin(quotes) {
    quotes.forEach(function (quote) {
      ...
      if (window.getComputedStyle(quoteImage).getPropertyValue("margin-right") === "".concat(quoteImageRightMargin, "px")) {
