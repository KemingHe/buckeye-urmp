// ./src/constants/osuEnums.ts
//
// Native enums containing data about OSU undergraduate year, pre prof, and major.

// Undergraduate year enums.
export enum UndergradYears {
...
export enum UndergradPreProfRoutes {
